...
fviz_dend(hc_subtypes, k = k_cut, cex = 1,  k_colors = c("#2E9FDF", "#00AFBB", "#E7B800", "#FC4E07", "#AA4371"),
...
qgraph(consensus_by_groups[[1]], 
       shape = "rectangle", vsize = sapply(colnames(consensus_by_groups[[1]]), nchar)*2, vsize2 = 2.5,
       ...
       label.cex = 0.8, label.prop = 0.5, negDashed = TRUE, edge.color = "black", edge.width = 0.5, layout = "spring",
       layout.par = list(repulse.rad = nrow(consensus_by_groups[[1]])^(2.5)))

qgraph(consensus_by_groups[[2]], 
       shape = "rectangle", vsize = sapply(colnames(consensus_by_groups[[2]]), nchar)*2, vsize2 = 2.5,
